...
class Scraper_project:
    ...
    def find_container_type(self): 
        self.cont = self.find_container()
        return type(self.cont)
    ...
    def extract_data(self):
        ...
        self.link_lists = []
        for i in range(0,50):
            self.page_container = self.driver.find_element(By.XPATH, '//div[@class="search-results-list"]')
            ...
            next = self.driver.find_element(By.XPATH, '//a[@class="next "]')
            next.click()
    ...
    def save_data(self):
        ...
        self.parent_dir = "C:/Users/preco/OneDrive/Desktop/AiCore/Web_Scraping" 
        ...
        with open("./raw_data2/books_2.json", "w") as outfile:
            json.dump(self.book_dict, outfile)
...
if __name__ == '__main__':
    ...
    bot.bestsellers()
    bot.bestsellers_click()
    bot.find_container()
    bot.find_container_type()
    bot.extract_data()
    bot.save_data()
